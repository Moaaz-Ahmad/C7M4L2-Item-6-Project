...
class MainActivity : ComponentActivity() {
    private val database by lazy {Room.databaseBuilder(this, MenuDatabase::class.java, "menu.db").build()}
        ...
        setContent {
            LittleLemonMenuEditorTheme {
                Surface(
                    ...
                    val menuItems by database.menuDao.getAllMenuItems().observeAsState(listOf())
                        ...
                        Button(
                            ...
                            onClick = {
                                ...
                                lifecycleScope.launchWhenCreated {
                                    withContext(IO) {
                                        database.menuDao.insertMenuItem(newMenuItem)
                                    }
                                }
                                dishName = ""
                                priceInput = ""
